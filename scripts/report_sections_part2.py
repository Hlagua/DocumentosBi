...
def build_part2(doc):
    ...
    add_bullet(doc, "Al ponderar por el factor ITF, el score para Seguros asciende a 0.1975 × 1.9550 = 0.3861, mientras que el score para Servicios del Hogar se comprime a 0.2936 × 0.1105 = 0.0324 (reduciéndose en un factor de 9.05 veces frente a su valor no ponderado, resultando casi 12 veces menor que el score de Seguros: 0.0324 vs. 0.3861). El orden de recomendación se reestructura completamente, posicionando a Pago de Seguros en el primer lugar absoluto del ranking.", "Con Ponderación ITF (Rescate de Alto Margen):")
